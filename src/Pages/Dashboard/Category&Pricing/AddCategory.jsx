...
const AddCategory = ({ children, className, refetch }) => {
    ...
    const handleAddCategory = async (e) => {
        ...
        try {
            const { data: result } = await axios.post("http://localhost:5000/categoryandpricing", formData)
                    ...
                    <div className="w-full max-w-lg mx-auto bg-white rounded-xl ">
                        <div className="mb-6">
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                Add a new room category to your hotel.
                            </p>
                        </div>

                        <form onSubmit={handleAddCategory} ref={formRef} className="space-y-5">
                            {/* Category Name */}
                            <div>
