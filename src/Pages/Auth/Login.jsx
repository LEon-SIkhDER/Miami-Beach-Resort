    ...
    return (
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-200/80 p-5 sm:p-8 m-2 sm:m-4 space-y-5">
            ...
            <div className="text-center space-y-2">
                ...
                <h2 className="text-xl sm:text-2xl font-extrabold font-serif text-slate-900 tracking-tight">Miami Beach Resort</h2>
                <p className="text-xs text-slate-500 font-medium">Log in to manage your bookings and dashboard</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5">
                ...
                >
                    {isSubmitting ? <span className="loading loading-spinner" /> : <><span>Sign In</span> <ArrowRight size={15} /></>}
                </button>
            </form>
            ...
            <p className="text-center text-xs text-slate-500 pt-1">
                Don't have an account? <Link to="/register" className="text-teal-700 font-bold hover:underline">Register here</Link>
            </p>
        </div>
    )
}
